...
inline const char* ordering_method_to_string(OrderingMethod method) {
    switch (method) {
        case OrderingMethod::AMD: return "AMD";
        case OrderingMethod::CAMD: return "CAMD";
        case OrderingMethod::METIS: return "METIS";
        case OrderingMethod::NESDIS: return "NESDIS";
        case OrderingMethod::COLAMD: return "COLAMD";
        case OrderingMethod::NATURAL: return "NATURAL";
        case OrderingMethod::NONE: return "NONE";
