...
public:
    ...
    CliqueCover(index_t n_vertices,
    ...
    const std::vector<index_t>& vertex_cliques_ptr() const { return vertex_cliques_ptr_; }
    ...
    struct Options {
        ...
        Options()
            : use_maximal_cliques(true),
              use_parallel(true),
              max_clique_enum_vertices(100000),  // Use triangles for graphs > 100k vertices
              greedy_only(false),
              num_threads(-1) {}
    };
